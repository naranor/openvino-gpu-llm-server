...
echo "=== OpenVINO GPU API Server: Qwen 3 14B Instruct (INT8) ==="
...
# Qwen 3 14B is the 2026 flagship dense model for coding and logic
MODEL_REPO="OpenVINO/Qwen3-14B-int8-ov"
MODEL_DIR="models/Qwen3-14B-int8-ov"

if [ ! -d "$MODEL_DIR" ]; then
    echo "Downloading Qwen3-14B OpenVINO INT8 (~15GB)..."
