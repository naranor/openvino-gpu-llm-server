...
echo "=== OpenVINO GPU API Server: Mistral-Nemo-12B-Instruct (INT8) ==="
...
# This is a community export, verified for 2026 standards
MODEL_REPO="CelesteImperia/Mistral-Nemo-12B-Instruct-OpenVINO-INT8"
MODEL_DIR="models/Mistral-Nemo-12B-Instruct-int8-ov"

if [ ! -d "$MODEL_DIR" ]; then
    echo "Downloading Mistral-Nemo 12B OpenVINO INT8 (takes full advantage of 28GB RAM)..."
