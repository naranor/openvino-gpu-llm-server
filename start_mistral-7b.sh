...
echo "=== OpenVINO GPU API Server: Mistral-7B-Instruct-v0.3 (INT8) ==="
...
MODEL_REPO="OpenVINO/Mistral-7B-Instruct-v0.3-int8-ov"
MODEL_DIR="models/Mistral-7B-Instruct-v0.3-int8-ov"

if [ ! -d "$MODEL_DIR" ]; then
    echo "Downloading Mistral-7B OpenVINO INT8..."
