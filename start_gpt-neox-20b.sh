...
echo "=== OpenVINO GPU API Server: GPT-NeoX-20B (INT8 Research) ==="
...
# GPT-NeoX-20B is the classic heavy-hitter from EleutherAI
MODEL_REPO="OpenVINO/gpt-neox-20b-int8-ov"
MODEL_DIR="models/gpt-neox-20b-int8-ov"

if [ ! -d "$MODEL_DIR" ]; then
    echo "Downloading GPT-NeoX-20B OpenVINO INT8 (~21GB)..."
